  ...
  return (
        ...
        <div className=''>
          <div className='flex xs:block lg:flex'>
            <div className='xs:h-[465px] xs:w-[100vw] xs:bg-yellow-300 xs:mt-[100px] lg:hg-[465px] lg:w-[75vw] xl:h-[465px] xl:w-[80vw] xl:bg-pink-500 2xl:h-[500px] 2xl:w-[80vw]  z-10'>
            </div>
            <div className='xs:h-[595px] xs:w-auto xs:mt-[50px] xs:ms-[15px] sm:h-[600px] sm:w-auto md:h-[600px] md:w-auto lg:h-[575px] lg:w-[100vw] lg:ml-[-50px] xl:h-[570px] xl:w-[100vw] xl:ml-[-60px] 2xl:h-[600px] border-[2px] border-black'>
