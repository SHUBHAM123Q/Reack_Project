...
const Sec1 = () => {
  return (
    <>
      <div className='shubham md:h-[480px] lg:h-[500px] xl:h-[600px] 2xl:h-[600px]'>
      ...
      <div className='mt-[-150px]'>
        <div className='sm:max-w-[550px] sm:m-auto md:max-w-[700px] md:m-auto lg:max-w-[900px] xl:max-w-[1120px] xl:m-auto 2xl:max-w-[1400px]'>
          <div className='grid aa:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-5'>
