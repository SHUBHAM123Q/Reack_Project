                ...
                <div className='h-[700px] sm:w-[550px] xl:w-[500px] m-auto shadow-2xl'>
                    <div className='grid xs:grid-cols-1'>
                        <div className=''>
                            ...
                            <div className='sm:flex  sm:justify-between m-auto sm:w-[400px] mt-5'>
                                <div className='flex'>
                            ...
                            <button className='bg-[#f50963] text-white text-[20px] m-auto flex mt-5 xs:px-[90px] sm:px-[170px] py-3' >Sign Up</button>
