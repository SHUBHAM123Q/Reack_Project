                ...
                <div className='flex justify-between bg-[#2a2b36] h-[60px] items-center px-3 flex-wrap'>
                    <div className=''>
                        <ul className='flex gap-4'>
                            <i className="fa-solid fa-bars text-[20px] mt-[3px] text-white"></i>
                    ...
                    <div className=''>
                        <ul className='gap-10 flex flex-wrap'>
                            <li className='flex text-center items-center'>
                                <div className='w-12 rounded-s-md bg-purple-600 py-1'><i className='bi bi-sun text-lg'></i></div>
                                <div className='w-12 rounded-e-md bg-purple-500 py-1'><i className='bi bi-moon text-lg'></i></div>
                            </li>
                            <li>
                                <i class="bi bi-bell text-[23px] text-white opacity-75 hover:opacity-100 active:opacity-100 relative">
                            ...
                            <li>
                                <i class="bi bi-list-task text-[25px] text-white opacity-75 hover:opacity-100 active:opacity-100 relative">
                            ...
                            <li>
                                <i class="bi bi-envelope-open text-[23px] text-white opacity-75 hover:opacity-100 active:opacity-100 relative">
                            ...
                            <li>
                                <img
                                    src="	https://coreui.io/demos/react/4.6/dark/static/media/8.35ee8919ea545620a475.jpg"
                                    alt="no image"
                                    className="rounded-full w-9"
                                />
                            </li>
                            <li><i class="bi bi-ui-radios-grid text-[23px] text-white opacity-75 hover:opacity-100"></i></li>
                        </ul>
                    </div>
                </div>
